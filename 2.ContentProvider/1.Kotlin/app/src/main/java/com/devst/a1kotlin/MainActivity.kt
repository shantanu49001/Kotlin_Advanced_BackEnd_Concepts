...
class MainActivity : AppCompatActivity() {
    lateinit var textShw: TextView
    private val mColumnProkection =     //columns needed in table
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        textShw = findViewById(R.id.textShow)
        ...
        val cursor = contentResolver.query(
            ContactsContract.Contacts.CONTENT_URI, mColumnProkection, null, null, null
        )
