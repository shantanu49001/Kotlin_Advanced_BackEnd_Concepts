...
//import com.lukaslechner.coroutineusecasesonandroid.playground.utils.StructuredConcurrency.scope
...
class ContinueCoroutineWhenUserLeavesScreenViewModel(
    ...
    fun loadData() {
        ...
        viewModelScope.launch {
            ...
            try {
                //we have to keep this running  even if the user leves the scrren
                uiState.value = UiState.Success(
                    DataSource.Network, repository.loadAndStoreRemoteAndroidVersions()
                )
